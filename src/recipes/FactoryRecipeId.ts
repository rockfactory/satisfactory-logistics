...
export type FactoryRecipeId =
  ...
  | 'RecipeCustom_Build_GeneratorCoal_C_Desc_Coal_C'
  | 'RecipeCustom_Build_GeneratorCoal_C_Desc_CompactedCoal_C'
  | 'RecipeCustom_Build_GeneratorCoal_C_Desc_PetroleumCoke_C'
  | 'RecipeCustom_Build_GeneratorFuel_C_Desc_LiquidFuel_C'
  | 'RecipeCustom_Build_GeneratorFuel_C_Desc_LiquidTurboFuel_C'
  | 'RecipeCustom_Build_GeneratorFuel_C_Desc_LiquidBiofuel_C'
  | 'RecipeCustom_Build_GeneratorFuel_C_Desc_RocketFuel_C'
  | 'RecipeCustom_Build_GeneratorFuel_C_Desc_IonizedFuel_C'
  | 'RecipeCustom_Build_GeneratorBiomass_Automated_C_Desc_Leaves_C'
  | 'RecipeCustom_Build_GeneratorBiomass_Automated_C_Desc_Wood_C'
  | 'RecipeCustom_Build_GeneratorBiomass_Automated_C_Desc_Mycelia_C'
  | 'RecipeCustom_Build_GeneratorBiomass_Automated_C_Desc_GenericBiomass_C'
  ...
  | 'RecipeCustom_Build_GeneratorNuclear_C_Desc_PlutoniumFuelRod_C'
  | 'RecipeCustom_Build_GeneratorNuclear_C_Desc_FicsoniumFuelRod_C';
